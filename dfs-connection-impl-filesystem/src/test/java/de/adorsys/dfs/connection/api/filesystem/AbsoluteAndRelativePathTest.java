...
public class AbsoluteAndRelativePathTest {
    ...
    public void realtivePath() {
        try {
            ...
            ExtendedStoreConnection con = new RealFileSystemExtendedStorageConnection(new FilesystemRootBucketName(mydir));
    ...
    public void absolutePath() {
        try {
            ...
            ExtendedStoreConnection con = new RealFileSystemExtendedStorageConnection(new FilesystemRootBucketName(absoluteDir));
            con.createContainer(new BucketDirectory("home"));
            con.putBlob(new BucketPath("/home/file1.txt"), new SimplePayloadImpl(new SimpleStorageMetadataImpl(), "affe".getBytes()));
